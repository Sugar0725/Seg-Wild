...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.sh_degree = 3
        self._source_path = ""
        self._foundation_model = "sam"  ### 设置特征提取大模型
        self._model_path = ""
        self._images = "images"
        ...
        self.use_semantic_feature = True
        if self.use_semantic_feature:
            self.semantic_feature_loss_coef = 0.7
            self.semantic_feature_iters = 20000
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.densify_from_iter = 500               #密度更新查询轮数
