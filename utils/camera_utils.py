...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  FoVx=cam_info.FovX, FoVy=cam_info.FovY, 
                  image=gt_image, gt_alpha_mask=loaded_mask, semantic_feature=gt_semantic_feature,
                  image_name=cam_info.image_name, uid=id, data_device=args.data_device,intrinsic_matrix=intrinsic)
